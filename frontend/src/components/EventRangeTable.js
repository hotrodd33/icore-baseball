...
const ALL_EVENTS = [
  'strikeout',
  'double_play_combined',
  'field_out_ground_ball',
  'field_out_popup',
  'field_out_fly_ball',
  'field_out_line_drive',
  'field_error',
  'walk',
  'hit_by_pitch',
  'single',
            ...
            return (
              <tr key={event}>
                ...
                {counts.map((count) => {
                  ...
                  const isFullMatch =
                    isEventHighlighted && isColumnHighlighted && isInRange
                  ...
                  return (
                    <td key={`${event}-${count}`} className={className}>
                      <div className="fill-bar-container">
                        ...
                        ></div>
                        {eventData &&
                          eventData.range_start !== null &&
                          eventData.range_end !== null && (
